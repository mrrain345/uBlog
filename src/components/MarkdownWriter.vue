    ...
    <div id="toolbar" class="row">
      <div class="col-12">
        <div class="btn-group" style="margin-right: 5px;">
          <button
            type="button"
            class="btn btn-success dropdown-toggle header"
        ...
        <div class="btn-group" style="margin-right: 5px;" role="group" aria-label="Basic example">
          <button type="button" class="btn btn-success" @click="insert('**')">
        ...
        <button type="button" class="btn btn-success" @click="set_list()">
...
export default {
  ...
  methods: {
    ...
    insert(str) {
      ...
      this.set_text(
        text,
        str === txt2 ? -str.length : str.length,
        str === txt4 ? -str.length : str.length
      );
    },
